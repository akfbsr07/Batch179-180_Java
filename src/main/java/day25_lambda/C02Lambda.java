...
public class C02Lambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkAnyCourseNameHasGivenString(courses, "J"));

        System.out.println(checkSeasonWinterAndAvgScore96(courses, "Winter", 96));
    ...
    public static boolean checkAnyCourseNameHasGivenString(List<Course> list, String s){

        return list.stream().anyMatch(t->t.getCourseName().contains(s));

    }

    //Example 3: Create a method to check if the season is Winter and the avg score is less than 96
    public static boolean checkSeasonWinterAndAvgScore96(List<Course> list, String s, double avg){

       return list.stream().anyMatch(t->t.getSeason().equals(s) && t.getAvgScore()<avg);

    }

    //Example 4: Create a method to print the course whose number of students is highest
