...
public class C01LinkedList {
    ...
    public static void main(String[] args) {
        ...
        //if you want to remove an integer "node", convert it to wrapper class
        // then put it inside the remove() parenthesis like the example below
        // if you put the integer directly inside remove() parenthesis, Java will accept it as index
        linkedList.remove((Integer)12);
        System.out.println(linkedList); // [6, 5, 2]


        System.out.println(linkedList.remove()); //6 ==> // Retrieves and removes the head (first element) of this list. - Like "cut+paste"
        System.out.println(linkedList); // [5, 2]

        int removedNode = linkedList.removeFirst(); // Removes and returns the first element from this list.
        ...
        myList.add(13);
        myList.add(100);
        System.out.println(myList); //[2, 5, 13]
