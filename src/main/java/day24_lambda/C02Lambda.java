...
public class C02Lambda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkToBeGreaterThan(names, 5));

        System.out.println(checkAnyElementToBeGreaterThan(names, 4));

        System.out.println(checkAnyElementToBeGreaterThan(names, 13));

        System.out.println(checkNotToStartWithGivenValue(names, " "));

    }

    //Example 1: Print the list elements on the console with all chars in uppercase by sorting in ascending order by using length
