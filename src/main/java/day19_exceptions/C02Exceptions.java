...
public class C02Exceptions {
    ...
    public static void main(String[] args) {
        ...
        getElementFromArrayByIndex(s, 4); //ArrayIndexOutOfBoundsException: Java throws this exception if you use non-existing index in an array

        System.out.println(convertStringToInt("123") + 1);
        System.out.println(convertStringToInt("0") + 1 );
        System.out.println(convertStringToInt("-2") + 1);
        System.out.println(convertStringToInt("1a2") + 0); // NumberFormatException: Java throws this exception
